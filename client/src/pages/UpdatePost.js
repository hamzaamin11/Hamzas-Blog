...
const UpdatePost = () => {
  ...
  console.log("whole params are get",useParams())
  console.log("formData ********", formData);
  console.log("paramsss", postId);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.put(
        `${BASE_URL}/server/post/updatepost/${formData._id}/${currentUser._id}`,
        formData,
        {
    ...
    const fetchPost = async () => {
      try {
        const res = await axios.get(
          `${BASE_URL}/server/post/getposts?postId=${postId}`
        );
        console.log("its calls");
